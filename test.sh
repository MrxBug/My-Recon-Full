...
cat "$folder/liveports.txt","$folder/live_subdomains.txt" | anew "$folder/nucleiDo.txt"
cat "$folder/nucleiDo.txt" | nuclei -severity low,medium,high,critical -o "$folder/severity.txt"
